    ...
    <div class="carousel-track" id="depo-track">
      ...
      <div class="carousel-slide card-type-video">
        <div class="slide-video-wrapper">
          <iframe src="https://www.youtube.com/embed/K1O_x_HiYIo?rel=0&modestbranding=1&playsinline=1" title="Depoimento Fernanda Folle" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen referrerpolicy="strict-origin-when-cross-origin" loading="lazy"></iframe>
        </div>
      ...
      <div class="carousel-slide card-type-video">
        <div class="slide-video-wrapper">
          <iframe src="https://www.youtube.com/embed/I3q8K-Shdas?rel=0&modestbranding=1&playsinline=1" title="Depoimento Adriana Guedes" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen referrerpolicy="strict-origin-when-cross-origin" loading="lazy"></iframe>
        </div>
        <div class="slide-content">
      ...
      <div class="carousel-slide card-type-video">
        <div class="slide-video-wrapper">
          <iframe src="https://www.youtube.com/embed/Zhi-YzQCIw8?rel=0&modestbranding=1&playsinline=1" title="Depoimento Melissa Pinesso" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen referrerpolicy="strict-origin-when-cross-origin" loading="lazy"></iframe>
        </div>
        <div class="slide-content">
